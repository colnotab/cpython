                       ...
                       int preserve_tos)
{
    ...
    switch (info->fb_type) {
        ...
        case WITH:
        case ASYNC_WITH:
            start_loc = c->u->u_lineno;
            end_loc = c->u->u_end_lineno;
            ...
            ADDOP(c, POP_TOP);
            c->u->u_lineno = start_loc;
            c->u->u_end_lineno = end_loc;
            return 1;
...
struct assembler {
    ...
    PyObject *a_enotab;     /* string containing enotab */
    PyObject *a_cnotab;     /* string containing cnotab */
...
static int
assemble_emit_table_pair(struct assembler *a, PyObject **table, int *offset, int left, int right)
{
...
makecode(struct compiler *c, struct assembler *a, PyObject *consts, int maxdepth)
{
    ...
    co = PyCode_NewWithPosOnlyArgs(posonlyargcount+posorkeywordargcount,
                                   ...
                                   enotab, cnotab, a->a_except_table);
    Py_DECREF(consts);
 error:
    Py_XDECREF(names);
    Py_XDECREF(varnames);
