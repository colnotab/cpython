...
_PyCode_Validate(struct _PyCodeConstructor *con)
{
    ...
    if (con->argcount < con->posonlyargcount || con->posonlyargcount < 0 ||
        ...
        con->enotab == NULL || (con->enotab != Py_None && !PyBytes_Check(con->enotab)) ||
        con->cnotab == NULL || (con->cnotab != Py_None && !PyBytes_Check(con->cnotab)) ||
...
init_code(PyCodeObject *co, struct _PyCodeConstructor *con)
{
    ...
    Py_INCREF(con->enotab);
    co->co_enotab = con->enotab;
    Py_INCREF(con->cnotab);
    co->co_cnotab = con->cnotab;
...
PyCode_NewWithPosOnlyArgs(int argcount, int posonlyargcount, int kwonlyargcount,
                          ...
                          PyObject *linetable, PyObject *enotab, PyObject *cnotab,
...
PyCode_New(int argcount, int kwonlyargcount,
           ...
           PyObject *varnames, PyObject *freevars, PyObject *cellvars,
           PyObject *filename, PyObject *name, int firstlineno,
           PyObject *linetable, PyObject *cnotab, PyObject *enotab,
           PyObject *exceptiontable)
{
...
code.__new__ as code_new
    ...
    enotab: object(subclass_of="&PyBytes_Type")
...
code_new_impl(PyTypeObject *type, int argcount, int posonlyargcount,
              ...
              PyObject *cnotab, PyObject *exceptiontable, PyObject *freevars,
              PyObject *cellvars)
/*[clinic end generated code: output=406c096405b318bf input=c9d41e7bd939d6f0]*/
{
    PyObject *co = NULL;
...
static PyMemberDef code_memberlist[] = {
    ...
    {"co_cnotab",       T_OBJECT,       OFF(co_linetable),       READONLY},
    {"co_enotab",       T_OBJECT,       OFF(co_linetable),       READONLY},
...
code.replace
    ...
    *
    ...
    co_enotab: PyBytesObject(c_default="(PyBytesObject *)self->co_enotab") = None
...
/*[clinic end generated code: output=5cc75e3fcc00fa90 input=0c524540263fb638]*/
{
...
#undef CHECK_INT_ARG
    ...
    co = PyCode_NewWithPosOnlyArgs(
        ...
        co_firstlineno, (PyObject*)co_linetable, (PyObject*)co_cnotab, (PyObject*)co_enotab,
