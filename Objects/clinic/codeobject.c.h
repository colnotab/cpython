...
"     firstlineno, linetable, exceptiontable, node_ids, freevars=(),\n"
"     cellvars=(), /)\n"
"--\n"
"\n"
...
code_new(PyTypeObject *type, PyObject *args, PyObject *kwargs)
{
    ...
    node_ids = PyTuple_GET_ITEM(args, 15);
...
skip_optional:
    return_value = code_new_impl(type, argcount, posonlyargcount, kwonlyargcount, nlocals, stacksize, flags, code, consts, names, varnames, filename, name, firstlineno, linetable, exceptiontable, node_ids, freevars, cellvars);
...
"        co_linetable=None, co_exceptiontable=None, co_nodeids=None)\n"
"--\n"
"\n"
...
{
    PyObject *return_value = NULL;
    static const char * const _keywords[] = {"co_argcount", "co_posonlyargcount", "co_kwonlyargcount", "co_nlocals", "co_stacksize", "co_flags", "co_firstlineno", "co_code", "co_consts", "co_names", "co_varnames", "co_freevars", "co_cellvars", "co_filename", "co_name", "co_linetable", "co_exceptiontable", "co_nodeids", NULL};
    ...
    PyObject *co_nodeids = self->co_nodeids;
    ...
    if (!PyTuple_Check(args[17])) {
        _PyArg_BadArgument("replace", "argument 'co_nodeids'", "tuple", args[17]);
        goto exit;
    }
    co_nodeids = args[17];
skip_optional_kwonly:
    return_value = code_replace_impl(self, co_argcount, co_posonlyargcount, co_kwonlyargcount, co_nlocals, co_stacksize, co_flags, co_firstlineno, co_code, co_consts, co_names, co_varnames, co_freevars, co_cellvars, co_filename, co_name, co_linetable, co_exceptiontable, co_nodeids);

exit:
    return return_value;
}
/*[clinic end generated code: output=39fcf97237a97132 input=a9049054013a1b77]*/
