...
"     firstlineno, linetable, columntable, freevars=(), cellvars=(), /)\n"
"--\n"
"\n"
...
code_new(PyTypeObject *type, PyObject *args, PyObject *kwargs)
{
    ...
    columntable = PyTuple_GET_ITEM(args, 14);
...
skip_optional:
    return_value = code_new_impl(type, argcount, posonlyargcount, kwonlyargcount, nlocals, stacksize, flags, code, consts, names, varnames, filename, name, firstlineno, linetable, columntable, freevars, cellvars);
...
"        co_linetable=None, co_columntable=None)\n"
"--\n"
"\n"
...
{
    PyObject *return_value = NULL;
    static const char * const _keywords[] = {"co_argcount", "co_posonlyargcount", "co_kwonlyargcount", "co_nlocals", "co_stacksize", "co_flags", "co_firstlineno", "co_code", "co_consts", "co_names", "co_varnames", "co_freevars", "co_cellvars", "co_filename", "co_name", "co_linetable", "co_columntable", NULL};
    ...
    if (!PyTuple_Check(args[16])) {
        _PyArg_BadArgument("replace", "argument 'co_columntable'", "tuple", args[16]);
        goto exit;
    }
    co_columntable = args[16];
skip_optional_kwonly:
    return_value = code_replace_impl(self, co_argcount, co_posonlyargcount, co_kwonlyargcount, co_nlocals, co_stacksize, co_flags, co_firstlineno, co_code, co_consts, co_names, co_varnames, co_freevars, co_cellvars, co_filename, co_name, co_linetable, co_columntable);

exit:
    return return_value;
}
/*[clinic end generated code: output=f75218300732a41b input=a9049054013a1b77]*/
